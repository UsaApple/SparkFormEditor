...
namespace SparkFormEditor
{
    ...
    */
    ...
    internal class MyOpaqueLayer : System.Windows.Forms.Control
    {
        ...
        private int _alpha = 125;//设置透明度125
        ...
        public MyOpaqueLayer(int Alpha, bool IsShowLoadingImage)
        {
            ...
            if (IsShowLoadingImage)
            {
                ...
                pictureBox_Loading.Image = SparkFormEditor.Properties.Resources.loading;  
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            //    "复制", new Font("宋体", 8),
            //    new SolidBrush(Color.DarkGray), new Point(1, 1));

            ////这个边框效果，是目前最好的
            //ControlPaint.DrawBorder(g, new Rectangle(_PictureBoxSelectArea.Location,_PictureBoxSelectArea.Size), Color.Red, ButtonBorderStyle.Dashed);
        }
